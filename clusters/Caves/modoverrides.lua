return {
  ...
  ["workshop-2970766790"]={ configuration_options={  }, enabled=true },
  ["workshop-3050607025"]={
    configuration_options={
      ANNOUNCE_MODE=false,
      AUTO_CLEAN=true,
      ...
      CLEAN_DAYS=5,
      EmptyNull=0,
      STACK_OTHER_OBJECTS="A",
      STACK_RADIUS=10,
      STACK_SIZE=100,
      TEST_MODE=false,
      TREES_NO_REGROWTH=true,
      TREES_NO_STUMP=true,
      TWIGGY=false,
  ...
  ["workshop-3223103565"]={
    configuration_options={
      SIB=false,
      SSB=false,
      mod_support_enabled=true,
      sort_bookstation=false,
      sort_chest=true,
